export const locationResponseEmail = (
	{
		message,
		responseUserName,
		locationdId,
	}: {
		parentCommentUser: any;
		message: string;
		responseUserName: string;
		locationdId: string;
	},
	parentIsLocation: boolean
) => {
	return `
  ...
  <div style="font-size:0px;"><img class="t30" style="display:block;border:0;height:auto;width:100%;Margin:0;max-width:100%;" width="40" height="39.34375" alt="" src="https://www.roomsolvers.com/images/logo/roomSolvers.svg"/></div></td>
  </tr></table>
  ...
  <p class="t60" style="margin:0;Margin:0;font-family:BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif,'Fira Sans';line-height:26px;font-weight:400;font-style:normal;font-size:16px;text-decoration:none;text-transform:none;direction:ltr;color:#9095A2;text-align:left;mso-line-height-rule:exactly;mso-text-raise:3px;">Check it on the location :)</p></td>
  </tr></table>
  ...
  <p class="t120" style="margin:0;Margin:0;font-family:BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif,'Fira Sans';line-height:22px;font-weight:400;font-style:normal;font-size:14px;text-decoration:none;text-transform:none;direction:ltr;color:#9095A2;text-align:left;mso-line-height-rule:exactly;mso-text-raise:2px;">Room Solvers. All rights reserved</p></td>
  </tr></table>
  </td></tr></table></td>
  </tr></table>
  </td></tr></table></td>
