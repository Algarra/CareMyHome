export const clientHostConfirmationNotification = ({
  name,
  lastName,
  email,
  phone,
                                  ...
                                  <tr>
                                    <td>
                                      <table class="t43" role="presentation" cellpadding="0" cellspacing="0" align="center">
                                        ...
                                        <tr>
                                          <td class="t44" style="width:475px;">
                                            <p class="t50" style="margin:0;Margin:0;font-family:BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif,'Fira Sans';line-height:26px;font-weight:400;font-style:normal;font-size:16px;text-decoration:none;text-transform:none;direction:ltr;color:#9095A2;text-align:left;mso-line-height-rule:exactly;mso-text-raise:3px;"> - Room name: ${
                                              item.roomName
                                            }.</p>
                                          </td>
                                        </tr>
  ...
  }/${new Date(item.from).getFullYear()} - ${new Date(item.to).getDate()}/${
    new Date(item.to).getMonth() + 1
  }/${new Date(item.to).getFullYear()} (DD/MM/YYYY)
                                            </p>
                                          </td>
                                        </tr>
                                        <tr>
